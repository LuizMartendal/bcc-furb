...
public class EstacionamentoTeste {
    ...
    public void calcularValorDoEstacionamento() {
        ...
        //this.estacionamento.removerVeiculo("ABC-1233");
        /*
            Tivemos que comentar a linha acima por apresentar um erro,
             parece que houve uma confusão e o grupo que implementou o teste acabou removendo o mesmo veículo duas vezes
        */
