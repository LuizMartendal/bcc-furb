...
<%@ page import= "com.brrobotics.modelo.*" %>
<!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>AppWeb BrRobotics - Carrinho</title>
    </head>
    <body style="width: 750px">
        ...
        <p align="center">
            <input type="button" value="Continuar comprando" onclick="javascript:document.location = 'ListaRobos.jsp'" />
