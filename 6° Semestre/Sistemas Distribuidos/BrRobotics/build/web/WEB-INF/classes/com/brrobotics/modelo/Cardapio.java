...
public class Cardapio {
    ...
    private void montarCardapio() {
        ...
        rob = new Robo(2, "Robo Segurança", "Para vigiar a casa e expantar intrusos", 1500.0);
        this.cardapio.add(rob);
        rob = new Robo(3, "Robo Médico", "Para cuidar de você quando estiver doente", 2000.0);
        this.cardapio.add(rob);
