public class TesteClasseVeiculo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Buscando a = Esperado: MJT-7432 |  retorno: " + mapa.buscar(a.getPlaca()));

        System.out.println("Buscando b = Esperado: MIT-8008 |  retorno: " + mapa.buscar(b.getPlaca()));

        System.out.println("Buscando c = Esperado: MEI-4665 |  retorno: " + mapa.buscar(c.getPlaca()));

        System.out.println("Buscando d = Esperado: MIO-6668 |  retorno: " + mapa.buscar(d.getPlaca()));

        System.out.println("Buscando e = Esperado: DIO-3333 |  retorno: " + mapa.buscar(e.getPlaca()));

        System.out.println("Buscando f = Esperado: PAO-6472 |  retorno: " + mapa.buscar(f.getPlaca()));

        System.out.println("Buscando g = Esperado: CAO-2890 |  retorno: " + mapa.buscar(g.getPlaca()));

        System.out.println("Buscando h = Esperado: UVA-3939 |  retorno: " + mapa.buscar(h.getPlaca()));

        System.out.println("Buscando i = Esperado: OVO-0000 |  retorno: " + mapa.buscar(i.getPlaca()));

        System.out.println("Buscando j = Esperado: ABC-1234 |  retorno: " + mapa.buscar(j.getPlaca()));


        System.out.println("\n\nMétodo remover()\n");


        System.out.println("Buscando a = Esperado: MJT-7432 |  retorno: " + mapa.remover(a.getPlaca()));

        System.out.println("Buscando b = Esperado: MIT-8008 |  retorno: " + mapa.remover(b.getPlaca()));

        System.out.println("Buscando c = Esperado: MEI-4665 |  retorno: " + mapa.remover(c.getPlaca()));

        System.out.println("Buscando d = Esperado: MIO-6668 |  retorno: " + mapa.remover(d.getPlaca()));

        System.out.println("Buscando e = Esperado: DIO-3333 |  retorno: " + mapa.remover(e.getPlaca()));

        System.out.println("Buscando f = Esperado: PAO-6472 |  retorno: " + mapa.remover(f.getPlaca()));

        System.out.println("Buscando g = Esperado: CAO-2890 |  retorno: " + mapa.remover(g.getPlaca()));

        System.out.println("Buscando h = Esperado: UVA-3939 |  retorno: " + mapa.remover(h.getPlaca()));

        System.out.println("Buscando i = Esperado: OVO-0000 |  retorno: " + mapa.remover(i.getPlaca()));

        System.out.println("Buscando j = Esperado: ABC-1234 |  retorno: " + mapa.remover(j.getPlaca()));
